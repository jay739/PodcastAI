...
8. Expressiveness:
   - Feel free to add natural expressions like [laughs], [sighs], [chuckles], [clears throat], [excited], [emotional], etc.
   - These should reflect the tone/alignment of the speaker.

9. Special Message to LLM:
